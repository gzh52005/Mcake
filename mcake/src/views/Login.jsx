    ...
    return(
        <div className='login-box'>
            ...
            <p className='login-shu'>
                <img src={phone}></img>
                <input   onChange={(e)=>{changeusername(e.currentTarget.value)}} type="text" placeholder="用户名/手机号码" />
            </p>
            <p className='login-shu'>
                <img src={suo}></img>
                <input  type="text" placeholder="密码" onChange={(e)=>{changepassword(e.currentTarget.value)}}/>
            </p>
            <span>立即注册</span>
            <span>其他登陆方式</span>
