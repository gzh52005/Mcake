...
class Snack extends React.Component{
    ...
    // render(){
    //     return (
    //         <div className='snack' style={{flex:1}}>
    //             <ul className='snack-box' style={{display:'flex',flexWrap:'wrap'}}>
    //                 <li>
    //                     <div style={{width:47+'vw',margin:1.5+'vw'}}>1</div>
    //                 </li>
    //                 <li>
    //                     <div style={{width:47+'vw',margin:1.5+'vw'}}>2</div>
    //                 </li>
    //                 <li>
    //                     <div style={{width:47+'vw',margin:1.5+'vw'}}>3</div>
    //                 </li>
    //                 <li>
    //                     <div style={{width:47+'vw',margin:1.5+'vw'}}>4</div>
    //                 </li>
    //                 <li>
    //                     <div style={{width:47+'vw',margin:1.5+'vw'}}>5</div>
    //                 </li>
    //                 <li>
    //                     <div style={{width:47+'vw',margin:1.5+'vw'}}>6</div>
    //                 </li>
    //             </ul>
    //         </div>
    //     )
